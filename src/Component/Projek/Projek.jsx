...
import secretChat from "./img/secretChat.png";

const Projek = () => {
  return (
    <div>
      <div className="tempatProjeknya flex flex-wrap justify-center items-center mt-10">
        <div className="boxProjek bg-blue-100 p-5 w-96 flex flex-col items-center rounded-2xl shadow-lg m-2">
        ...
        <div className="boxProjek bg-blue-100 p-5 w-96 flex flex-col items-center rounded-2xl shadow-lg m-2">
          <img
            src={secretChat}
            className="h-40 w-auto m-auto mt-5 mb-5 rounded-xl"
          />
          <p className="font-semibold">SECRET CHAT (SECRETO CLONE)</p>
          <div className="flex">
            <div className="m-5 bg-blue-200 p-3 text-xs rounded-lg mt-5 text-blue-900 text-center">
              <a href="https://secret-chat-hazel.vercel.app/">VISIT PROJECT</a>
            </div>
          </div>
        </div>
      </div>
