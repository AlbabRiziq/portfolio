        ...
        <div className="bg-blue-50 w-[90%] max-w-4xl p-10 rounded-xl">
            <div className="flex justify-center content-center flex-col">
                <div className="flex justify-evenly items-center flex-col md:flex-row text-center">
                    ...
                    <div>
                        <h1 className="font-extrabold text-3xl text-slate-900">ALBAB RIZIQ</h1>
                        <p className="">STUDENT | WEB DEVELOPER | {umur()} YEARS OLD </p>

                    </div>
                </div>
                <p className="mt-10 text-center p-2 rounded-full">Interested in working with me? <a className="text-blue-600 font-bold" href="mailto:albabriziq123@gmail.com">EMAIL ME!</a></p>
                <br /><br /><br />
                <p className="font-bold text-xl text-slate-900 text-center">MORE ABOUT ME</p>
